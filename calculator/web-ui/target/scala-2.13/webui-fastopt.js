...
$c_Lcalculator_Calculator$.prototype.computeValues__sci_Map__sci_Map = (function(namedExpressions) {
  ...
  return $as_sci_Map(new $c_sc_MapOps$WithFilter().init___sc_MapOps__F1(namedExpressions, p).map__F1__sc_IterableOps(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(this$2, namedExpressions$1) {
    return (function(x$1$2) {
      var x$1 = $as_T2(x$1$2);
      if ((x$1 !== null)) {
        var refName = $as_T(x$1.$$und1$f);
        var exprSignal = $as_Lcalculator_Signal(x$1.$$und2$f);
        $m_Lcalculator_Signal$();
        var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function($this$1, exprSignal$1, namedExpressions$1$1) {
          return (function() {
            return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr(exprSignal$1.apply__O()), namedExpressions$1$1)
          })
        })(this$2, exprSignal, namedExpressions$1));
        return new $c_T2().init___O__O(refName, new $c_Lcalculator_Signal().init___F0(expr))
      } else {
        throw new $c_s_MatchError().init___O(x$1)
      }
    })
...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  _eval: while (true) {
    ...
    if ($is_Lcalculator_Literal(x1)) {
      ...
      var variable = x3.name$2;
      var e = this.getReferenceExpr__p1__T__sci_Map__Lcalculator_Expr(variable, references);
      var this$1 = references;
      var temp$references = $as_sci_Map(this$1.removed__O__sci_MapOps(variable));
      expr = e;
      ...
      var l = x4.a$2;
      var r = x4.b$2;
      return (this.eval__Lcalculator_Expr__sci_Map__D(l, references) + this.eval__Lcalculator_Expr__sci_Map__D(r, references))
    } else if ($is_Lcalculator_Minus(x1)) {
      var x5 = $as_Lcalculator_Minus(x1);
      var l$2 = x5.a$2;
      var r$2 = x5.b$2;
      return (this.eval__Lcalculator_Expr__sci_Map__D(l$2, references) - this.eval__Lcalculator_Expr__sci_Map__D(r$2, references))
    } else if ($is_Lcalculator_Times(x1)) {
      var x6 = $as_Lcalculator_Times(x1);
      var l$3 = x6.a$2;
      var r$3 = x6.b$2;
      return (this.eval__Lcalculator_Expr__sci_Map__D(l$3, references) * this.eval__Lcalculator_Expr__sci_Map__D(r$3, references))
    } else if ($is_Lcalculator_Divide(x1)) {
      var x7 = $as_Lcalculator_Divide(x1);
      var l$4 = x7.a$2;
      var r$4 = x7.b$2;
      return (this.eval__Lcalculator_Expr__sci_Map__D(l$4, references) / this.eval__Lcalculator_Expr__sci_Map__D(r$4, references))
    } else {
      throw new $c_s_MatchError().init___O(x1)
    }
  }
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function($this, delta$1, b$1, a$1) {
    return (function() {
      if (($uD(delta$1.apply__O()) >= 0)) {
        ...
        var root1 = (((-jsx$1) + $uD($g.Math.sqrt(a$2))) / (2 * $uD(a$1.apply__O())));
        var jsx$2 = $uD(b$1.apply__O());
        var a$3 = $uD(delta$1.apply__O());
        var root2 = (((-jsx$2) - $uD($g.Math.sqrt(a$3))) / (2 * $uD(a$1.apply__O())));
        var this$6 = $m_s_Predef$().Set$3;
        var array = [root1, root2];
        var elems = new $c_sjsr_WrappedVarArgs().init___sjs_js_Array(array);
...
$c_Lcalculator_TweetLength$.prototype.colorForRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(remainingCharsCount) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function($this, remainingCharsCount$1) {
    return (function() {
      var rcc = $uI(remainingCharsCount$1.apply__O());
      return ((rcc < 0) ? "red" : ((rcc >= 15) ? "green" : "orange"))
    })
...
$c_sc_MapOps$WithFilter.prototype.map__F1__sc_IterableOps = (function(f) {
  return $as_sc_IterableOps(this.self$3.mapFactory__sc_MapFactory().from__sc_IterableOnce__O(new $c_sc_View$Map().init___sc_IterableOps__F1(this.filtered__sc_Iterable(), f)))
});
